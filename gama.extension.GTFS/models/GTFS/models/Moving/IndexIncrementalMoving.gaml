...
global {
	...
	int current_seconds_mod -> int(current_date - date([1970,1,1,0,0,0])) mod 86400;
...
//	        
//	        speed <- distance_diff / (time_diff + 1);
//	        
//	        //if (trip_id = 1900169){write "speed: "+ speed + "time_diff: " + time_diff + "distance diff: " + distance_diff;}
//        }
//    }
