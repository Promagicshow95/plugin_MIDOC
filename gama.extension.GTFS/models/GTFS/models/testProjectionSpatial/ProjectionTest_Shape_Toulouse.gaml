    ...
    action show_detailed_comparison {
        ...
        loop shape_id over: map_gtfs_projected.keys {
            if map_gama contains_key shape_id {
                ...
                write "  GTFS proj: " + gtfs_data[0] + " (" + gtfs_data[1] + " points)";
                write "  GAMA pos:  " + gama_data[0] + " (" + gama_data[1] + " points)";
                write "  Distance:  " + string(gtfs_data[0] distance_to gama_data[0]) + "m";
                write "";
            }
        }
    }
